...
(function() {
  var BuiltInObjects, Clone, DefaultPkFactory, MongoObjects, ObjectID, applyToRegistered, async, commit, commitWithGlobalLock, execute, rollback, t, _chainCounter, _checkForChain, _checkTransaction, _clone, _commitCore, _config, _db, _drainQueues, _enqueue, _enqueueAndHandleChains, _executeImmediate, _hasAfter, _hasBefore, _immediateCounter, _immediately, _inSeries, _instructionsExistFor, _makeUpdateOptions, _mongoFlatten, _mongoOpsFromTo, _pending, _pendingImmediate, _pkFactory, _processRevisions, _pushTransactionError, _queueCountersCollection, _queueLength, _queuePosition, _queues, _registry, _registryFind, _requeue, _setUpTransaction, _shiftChain, _softwareVersion, _state, _transactionsCollection, _updateOpInstruction, _updateOpRollback, _updateTransactionState, _updateTransactionStatus, _withGlobalLock,
    __slice = [].slice,
