...
(function() {
  var DefaultPkFactory, ObjectID, applyToRegistered, async, commit, commitWithGlobalLock, execute, rollback, _checkInstructionRevisionConfig, _checkTransaction, _clone, _commitCore, _config, _db, _drainQueues, _enqueue, _enqueueOrCreateAndEnqueue, _executeImmediate, _hasAfter, _hasBefore, _immediateCounter, _immediately, _inSeries, _instructionsExistFor, _mongolize, _pending, _pendingImmediate, _pkFactory, _processUpdateRevisions, _pushTransactionError, _queueCountersCollection, _queueLength, _queuePosition, _queues, _registry, _registryFind, _requeue, _retry, _revisionedUpdateChecks, _setUpTransaction, _shiftChain, _softwareVersion, _state, _transactionsCollection, _updateOneOptions, _updateTransactionState, _updateTransactionStatus, _withGlobalLock,
    __slice = [].slice,
  ...
  _checkInstructionRevisionConfig = function(instructionName, config, collectionName, revisions) {
    var revisionName, _i, _len;
    if (revisions.length !== 0 && ((config.revisions == null) || (config.revisions[collectionName] == null))) {
  ...
  _processUpdateRevisions = function(revisions) {
  ...
  exports.db = {
    ...
    insert: function(config, transaction, state, _arg, done) {
      var collectionName, documents, error, etc, revisions;
    ...
    updateOneOp: function(config, transaction, state, _arg, done) {
      var collectionName, error, etc, revisionNames, revisionNumbers, revisions, rollbackOps, selector, updateOps, _ref;
      collectionName = _arg[0], selector = _arg[1], updateOps = _arg[2], rollbackOps = _arg[3], revisions = _arg[4], etc = 6 <= _arg.length ? __slice.call(_arg, 5) : [];
      if (etc.length !== 0) {
      ...
      _ref = _processUpdateRevisions(revisions), revisionNames = _ref[0], revisionNumbers = _ref[1];
      ...
      return config.db.collection(collectionName, {
        ...
        var mongoProjector, mongoSelector, revisionName;
        if (err != null) {
          return done(err, false);
        }
        ...
        return collection.find(mongoSelector, mongoProjector).toArray(function(err, docs) {
          ...
          return _updateTransactionState(transaction, function(err) {
            var executeUpdate, matches, revisionNumber;
            if (err != null) {
              return done(err, null);
            }
            executeUpdate = function() {
              var mongoUpdateOps, _i, _len;
            ...
            if (revisionNumbers != null) {
              matches = (function() {
                ...
                for (revisionName in revisionNumbers) {
                  ...
                  _results.push(state.updated[revisionName] === revisionNumber);
                }
                return _results;
              })();
    ...
    updateOneOpRollback: function(config, transaction, state, _arg, done) {
      var collectionName, etc, revisionNames, revisionNumbers, revisions, rollbackOps, selector, updateOps, _ref;
      collectionName = _arg[0], selector = _arg[1], updateOps = _arg[2], rollbackOps = _arg[3], revisions = _arg[4], etc = 6 <= _arg.length ? __slice.call(_arg, 5) : [];
      if (etc.length !== 0) {
        return done(new Error("too many values passed to updateOneOp"));
      }
        ...
        if (state.updated == null) {
          ...
          return collection.count(revisionSelector, function(err, count) {
            ...
            if (count === 1) {
              ...
              return collection.update(_mongolize(selector), mongoRollbackOps, _updateOneOptions, function(err, updated) {
                if (err != null) {
                  return done(err, false);
                }
                if (updated !== 1) {
    ...
    updateOneDoc: function(config, transaction, state, _arg, done) {
      ...
      collectionName = _arg[0], newPartialDocument = _arg[1], oldPartialDocument = _arg[2], revisionName = _arg[3], etc = 5 <= _arg.length ? __slice.call(_arg, 4) : [];
      if (etc.length !== 0) {
      ...
      if ((revisionName == null) || (config.revision == null)) {
