...
(function() {
  var DefaultPkFactory, ObjectID, applyToRegistered, async, commit, commitWithGlobalLock, execute, rollback, _checkTransaction, _clone, _db, _drainQueues, _enqueueOrCreateAndEnqueue, _immediateCounter, _instructionsExistFor, _mongolize, _pkFactory, _pushTransactionError, _queueCountersCollection, _queueLength, _queuePosition, _queues, _quietly, _registry, _registryFind, _revisionedUpdateChecks, _setUpTransaction, _softwareVersion, _state, _transactionsCollection, _updateOneOptions, _updateTransactionState, _updateTransactionStatus,
    __slice = [].slice;
