...
(function() {
  ...
  _updateOpInstruction = function(onlyOne, config, transaction, state, collectionName, selector, updateOps, rollbackProjector, revisions, etc, done) {
    var error, instructionName, revisionNames, revisionNumbers, _ref;
    instructionName = onlyOne ? 'updateOneOp' : 'updateManyOp';
    if (etc.length !== 0) {
      ...
      return collection.find(mongoSelector, mongoProjector).toArray(function(err, docs) {
        ...
        return _updateTransactionState(transaction, function(err) {
          ...
          executeUpdate = function() {
            ...
            if (onlyOne) {
              options = _updateOneOptions;
            } else {
              options = _updateManyOptions;
            }
  ...
  _updateOpRollback = function(onlyOne, config, transaction, state, collectionName, selector, updateOps, rollbackProjector, revisions, etc, done) {
    var instructionName, revisionNames, revisionNumbers, _ref;
