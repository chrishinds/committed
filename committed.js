...
(function() {
  var DefaultPkFactory, ObjectID, applyToRegistered, async, commit, execute, rollback, _db, _drainQueues, _enqueueOrCreateAndEnqueue, _instructionsExistFor, _mongolize, _pkFactory, _pushTransactionError, _queueCountersCollection, _queuePosition, _queues, _quietly, _registry, _registryFind, _revisionedUpdateChecks, _softwareVersion, _state, _transactionsCollection, _updateOneOptions, _updateTransactionStatus,
    __slice = [].slice;
